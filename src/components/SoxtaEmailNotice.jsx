...
export default function SoxtaEmailNotice() {
  ...
  return (
    ...
    >
      <div className="bg-white/2feat: show floating fake email notice
0 backdrop-blur-sm border border-gray-200 shadow-lg rounded-xl px-2 py-1 flex items-center gap-3">
